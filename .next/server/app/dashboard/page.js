...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 42638)), "C:\\Users\\abc\\Desktop\\Hadi\\My Bussiness\\jf\\jf- dash\\app\\dashboard\\page.tsx"],
          
        }]
      },
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 43551)), "C:\\Users\\abc\\Desktop\\Hadi\\My Bussiness\\jf\\jf- dash\\app\\dashboard\\layout.tsx"],
          metadata: {
    ...
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 60729)), "C:\\Users\\abc\\Desktop\\Hadi\\My Bussiness\\jf\\jf- dash\\app\\layout.tsx"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 83174))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["C:\\Users\\abc\\Desktop\\Hadi\\My Bussiness\\jf\\jf- dash\\app\\dashboard\\page.tsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 30967))
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 58733))
...
async function getUser() {
    try {
        const { data } = await axios__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z.get("/api/auth/me");
        return {
            user: data,
            error: null
        };
...
function ProductTable() {
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        ...
        children: [
            editingProduct && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(EditProductForm, {
            ...
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("table", {
                className: "table-auto w-full border-collapse border border-gray-200 mb-4",
                children: [
                    ...
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("tbody", {
                        children: filteredProducts.map((product)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("tr", {
...
function EditProductForm({ product, onCancel, onSave }) {
    const [title, setTitle] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(product.title);
    const [price, setPrice] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(product.price);
    const [stock, setStock] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(product.stock);
    const [weight, setWeight] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(product.weight || "");
    const [shipping, setShipping] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(product.shipping || "");
    const [sku, setSku] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(product.sku || "");
    const [videoLink, setVideoLink] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(product.videoLink || "");
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`C:\Users\abc\Desktop\Hadi\My Bussiness\jf\jf- dash\app\dashboard\layout.tsx`)
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`C:\Users\abc\Desktop\Hadi\My Bussiness\jf\jf- dash\app\dashboard\page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [381,202,813,24], () => (__webpack_exec__(45290)));
